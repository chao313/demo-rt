package demo.rt.out.es.controller;

import com.alibaba.fastjson.JSONObject;
import demo.rt.config.AwareUtil;
import demo.rt.engine.script.impl.JavaScriptExecuteScript;
import demo.rt.feign.DocumentService;
import demo.rt.feign.MappingService;
import demo.rt.feign.ScrollService;
import demo.rt.feign.SearchService;
import demo.rt.feign.plus.MappingServicePlus;
import demo.rt.feign.plus.ScrollServicePlus;
import demo.rt.feign.plus.SearchServicePlus;
import demo.rt.framework.Code;
import demo.rt.framework.Response;
import demo.rt.out.comm.OutType;
import demo.rt.out.db.mysql.service.DBService;
import demo.rt.out.kafka.KafkaMsg;
import demo.rt.out.kafka.KafkaOutService;
import demo.rt.out.remove.compound.Body;
import demo.rt.out.remove.compound.level.base.Terms;
import demo.rt.out.resource.service.ResourceService;
import demo.rt.po.response.ESResponse;
import demo.rt.po.response.InnerHits;
import demo.rt.po.response.buckets.BucketsRoot;
import demo.rt.thread.ThreadPoolExecutorService;
import demo.rt.util.DateUtil;
import demo.rt.util.ExcelUtil;
...
import static demo.rt.util.ExcelUtil.percent;
