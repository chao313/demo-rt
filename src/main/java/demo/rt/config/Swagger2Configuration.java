...
//                        .basePackage("demo.rt.controller.custom"))
...
//                .select()
//                .apis(RequestHandlerSelectors
//                        .basePackage("demo.rt.controller.origin"))
//                .paths(PathSelectors.any())
//                .build()
//                .genericModelSubstitutes(DeferredResult.class)//异步http请求
//                .forCodeGeneration(true)
...
//                .select()
//                .apis(RequestHandlerSelectors
//                        .basePackage("demo.rt.controller.helper"))
//                .paths(PathSelectors.any())
//                .build()
//                .genericModelSubstitutes(DeferredResult.class)//异步http请求
//                .forCodeGeneration(true)
...
//    }
    ...
    @Bean
    public Docket RedisPevcApi2() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors
                        .basePackage("demo.rt.controller.system"))
                .paths(PathSelectors.any())
                .build()
                .genericModelSubstitutes(DeferredResult.class)//异步http请求
                .forCodeGeneration(true)
