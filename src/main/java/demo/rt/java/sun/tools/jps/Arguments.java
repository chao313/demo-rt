...
////
//
//package demo.rt.java.sun.tools.jps;
//
...
//
//    public static void printUsage(OutputStream outputStream) throws IOException {
//        outputStream.write("usage: jps [-help]".getBytes());
//        outputStream.write("       jps [-q] [-mlvV] [<hostid>]".getBytes());
//        outputStream.write("".getBytes());
//        outputStream.write("Definitions:".getBytes());
//        outputStream.write("    <hostid>:      <hostname>[:<port>]".getBytes());
//    }
//
